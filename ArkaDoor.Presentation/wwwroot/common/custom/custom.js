...
var topBannerWwiper = new Swiper(".AdvertisementBanner", {
    loop: true,
    keyboard: {
        enabled: true,
    },
...
var buttonAppreciationBannerSwiper = new Swiper(".swiper-addvisor-footer", {
    loop: true,
    keyboard: {
        enabled: true,
    },
...
function ShowImgModal(id, src, alt) {
    ...
    var img = document.getElementById(`show_img_${id}`);
...
function initFancybox() {
    var boxes = $("[data-fancybox]");
    $.each(boxes, function (item) {
        //Fancybox.bind(item, {
...
//#region Notice Register Course User

function NoticeRegisterCourseUser(courseId) {
    Swal.fire({
        title: 'اعلان',
        text: "آیا از انجام عملیات مورد نظر اطمینان دارید ؟",
        icon: 'warning',
