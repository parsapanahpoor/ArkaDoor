...
function ChangeUserInfoState(userId, stateId) {
    ...
    $(".ChangeUserInfoState option[value='X']").remove();

    if (stateId == 3) {
        $.ajax({
            url: "/Admin/Account/ReasonOfRejectUserInfo",
            type: "get",
            data: {
                userId: userId
            },
...
function RejectUserInfo(response) {
    close_waiting();
    if (response.status === "Success") {
...
//#region CkeckOutRequestForPrivateCLass

function CkeckOutRequestForPrivateCLass(requestId, url) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status === 'Success') {
                ...
                $(`#request_btn_CkeckOut_${requestId}`).removeClass("display-inline-block");
                $(`#request_btn_CkeckOut_${requestId}`).addClass("display-none");
                $(`#request_btn_Recovery_${requestId}`).removeClass("display-none");
                $(`#request_btn_Recovery_${requestId}`).addClass("display-inline-block");
                $(`#request_state_Recovery_${requestId}`).removeClass("display-inline-block");
                $(`#request_state_Recovery_${requestId}`).addClass("display-none");
                $(`#request_state_CkeckOut_${requestId}`).removeClass("display-none");
                $(`#request_state_CkeckOut_${requestId}`).addClass("display-inline-block");
...
//#region RecoveryRequestForPrivateCLass

function RecoveryRequestForPrivateCLass(requestId, url) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status === 'Success') {
                ...
                $(`#request_btn_Recovery_${requestId}`).removeClass("display-inline-block");
                $(`#request_btn_Recovery_${requestId}`).addClass("display-none");
                $(`#request_btn_CkeckOut_${requestId}`).removeClass("display-none");
                $(`#request_btn_CkeckOut_${requestId}`).addClass("display-inline-block");
                $(`#request_state_CkeckOut_${requestId}`).removeClass("display-inline-block");
                $(`#request_state_CkeckOut_${requestId}`).addClass("display-none");
                $(`#request_state_Recovery_${requestId}`).removeClass("display-none");
                $(`#request_state_Recovery_${requestId}`).addClass("display-inline-block");
